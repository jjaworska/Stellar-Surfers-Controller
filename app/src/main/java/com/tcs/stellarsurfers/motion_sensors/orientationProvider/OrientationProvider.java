 ...
 * 
 */
package com.tcs.stellarsurfers.motion_sensors.orientationProvider;

import android.hardware.Sensor;
import android.hardware.SensorEventListener;
import android.hardware.SensorManager;

import com.tcs.stellarsurfers.motion_sensors.representation.MatrixF4x4;
import com.tcs.stellarsurfers.motion_sensors.representation.Quaternion;
...
public abstract class OrientationProvider implements SensorEventListener {
    public interface OrientationProviderListener {
        void notifySensorDataReceived();
    }

    protected List<OrientationProviderListener> listeners = new ArrayList<>();
    public void addListener(OrientationProviderListener listener) {
